...
@Component({
  selector: 'ms-exec-summary-dashboard',
  templateUrl: './exec-summary-dashboard.component.html',
  styleUrls: ['./exec-summary-dashboard.component.scss']
})
export class ExecSummaryDashboardComponent implements OnInit {
  // @ViewChild('_barchart1', {static: false}) Chart: ElementRef;
